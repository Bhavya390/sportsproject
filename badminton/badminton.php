...
body
{
  margin: 0;
  padding: 0;
  background: url(../Res/badminton.jpg) no-repeat center center fixed ;
}
...
<body>
  ...
  <div id="container">
    <div id="layer6" style="opacity:1;">
          ...
          <div id="banner">BADMINTON FEED</div>
          
      <div class="col" style="margin-left:10%"><div class="quote" >"Those who play badminton well take decisions quickly." <br>        -Dmitry Medvedev</div>         
      <div class="quote" >"I love winning more than I love playing badminton. Winning is everything."       -Saina Nehwal</div>         
      <div class="quote" >"In badminton, they use a lot from the wrist. But I use a lot from the shoulder."       -Li Na</div>          
      </div>
      <div class="col"><div class="quote" >"I don't care about movies. I tend to play badminton once a week."       -Anonymous</div>          
      <div class="quote" >"We put the bad in the badminton"       -Anonymous</div>          
      <div class="quote" >"Discipline is the bridge between your badmonton goals and badminton success"       -Felicity Luckey</div>          
      </div>
      <div class="col"><div class="quote" >"The art of badminton is to deceive"       -George Thomas</div>          
      ...
      <div class="col"><div class="quote" >"Even the worst day @badminton is better than the best day @work"       -Anonymous</div>         
