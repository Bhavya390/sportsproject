...
body
{
  margin: 0;
  padding: 0;
  background: url(../Res/basketball1.jpg) no-repeat center center fixed ;
}
...
<!--            <div class="bar-btn" id="admin">ADMIN</div>-->
          ...
          <div id="banner">BASKETBALL FEED</div>
