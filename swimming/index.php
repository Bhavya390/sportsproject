...
body
{
  margin: 0;
  padding: 0;
  background: url(../Res/swimbg.jpg) no-repeat center center fixed ;
}
...
<body>
  ...
  <div id="container">
    <div id="layer6" style="opacity:1;">
          ...
          <div id="banner">SWIMMING FEED</div>
...
document.getElementsByClassName("fix-bar").item(1).onclick=function(e){
  ...
  if(click.id.localeCompare("blog")==0)
    ...
    //
    var win=window.open("../blogpage/bloghome.php", '_blank');
        win.focus();window.location.assign("../blogpage/bloghome.php")  ; 
    }
