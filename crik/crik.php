...
body
{
    margin: 0;
    padding: 0;
    background: url(../Res/cric.jpg) no-repeat center center fixed ;
}
...
<body>
    ...
    <div id="container">
        <div id="layer6" style="opacity:1;">
            ...
            <div id="banner">CRICKET FEED</div>
            ...
            <div class="quote" >"I hate losing and cricket being my first love, once I enter the ground it's a different zone altogether and that hunger for winning is always there"       -Sachin Tendulkar</div>         
            </div>
            <div class="col"><div class="quote" >"In the game of cricket, a hero is a person who respects the game and does not corrupt the game. The one who doesn't or corrupts the game, they are the villain. They should be punished, and they have been punished in the past"       -Virat Kohli</div>            
            <div class="quote" >"To me, cricket is a simple game. Keep it simple and just go out and play"       -Shane Warne</div>         
            <div class="quote" >"Cricket is a pressure game, and when it comes to an India-Pakistan match the pressure is doubled"       -Imran Khan</div>          
            </div>
            <div class="col"><div class="quote" >"I was playing cricket first and my cricket coach was the one that introduced me to track and field"       -Usain Bolt</div>           
            ...
            <div class="quote" >"And I don't watch cricket. How can you like a game that requires you to take four days off work to follow a Test?"       -Thierry Henry</div>          
    ...
    ?>
                <div class="clb_s">
                    <div class="clb_n" ><span style="margin-left:2%"><?php echo $a[0];?></span></div>
                    <div class="clb_sc">To Win :<?php echo $a[3];?></div>
                </div>

                <div class="clb_s">
                    <div class="clb_n" ><span style="margin-left:2%"><?php echo $a[4];?></span></div>
                    <div class="clb_sc">To Win :<?php echo $a[7];?></div>
                </div>
            </div>
            <div id="news">
  ...
  foreach($data as $reach)
  {
    ?>
                <div class="players">
                    ...
                    <div class="pla_inf"><?php echo $reach['membername'];?><br> <?php echo $reach['pos'];?><br><?php echo $reach['dept'];?><br></div>
