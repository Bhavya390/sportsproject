...
body
{
  margin: 0;
  padding: 0;
  background: url(../Res/hb.jpg) no-repeat center center fixed ;
}
...
<body>
  ...
  <div id="container">
    <div id="layer6" style="opacity:1;">
          ...
          <div id="banner">HANDBALL FEED</div>
          
      <div class="col" style="margin-left:10%"><div class="quote" >"Winners never quit and quitters never win." <br>        -Vince Lombardi</div>         
      <div class="quote" >"Success is where preperation and oppurtunity meet"       -Bobby Unser</div>          
      <div class="quote" >"You can't put a limit on anything. The more you dream, the farther you get"       -Michael Phelps</div>          
      </div>
      <div class="col"><div class="quote" >"Just play. Have Fun. Enjoy the game"       -Michael Jordan</div>          
      <div class="quote" >"Sports do not build character. They reveal it"       -Heywood Broun</div>          
      <div class="quote" >"It's just a job. Grass grows, birds fly, waves pound the sand. I beat people up."       -Muhammad Ali</div>          
      </div>
      <div class="col"><div class="quote" >"If winning isn't everything, why do they keep score?"       -Vince Lombardi</div>         
      <div class="quote" >"When I am on the court I am a follower"       -Howard Bach</div>         
      ...
      <div class="col"><div class="quote" >"I am building a fire, and everyday I train, I add more fuel. At just the right moment, I light the match."       -Mia Hamm</div>          
      <div class="quote" >"Your dream will always defeat reality if you give it a chance"       -Anonymous</div>          
      <div class="quote" >"Dream big because little dreams have no magic"       -Anonymous</div>          </div>
